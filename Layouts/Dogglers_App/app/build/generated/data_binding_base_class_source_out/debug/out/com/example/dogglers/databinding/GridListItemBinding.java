...
public final class GridListItemBinding implements ViewBinding {
  ...
  private GridListItemBinding(@NonNull MaterialCardView rootView, @NonNull View border,
      @NonNull TextView dogAgeTextView, @NonNull TextView dogHobbiesTextView,
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GridListItemBinding((MaterialCardView) rootView, border, dogAgeTextView,
          dogHobbiesTextView, dogImageView, dogNameTextView);
    }
